...
public class AacContractReader
{
    ...
    public uint DecodeTokenByIndex(string result)
    {
        var function = GetFunctionTokenByIndex();
        return function.DecodeSimpleTypeOutput<uint>(result);
    }
