...
public class PlayContractReader
{
    ...
    {
        var function = GetFunctionBalanceOf();
        return function.DecodeDTOTypeOutput<BigInteger>(result);
    }
